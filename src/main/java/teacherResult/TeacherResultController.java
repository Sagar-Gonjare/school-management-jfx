...
public class TeacherResultController {
    ...
    public void save(ActionEvent event) {
    	...
    	if ((grn_Number.getText()).isEmpty() || 
    			(english.getText()).isEmpty() || 
    			(hindi.getText()).isEmpty() || 
    			(maths.getText()).isEmpty() || 
    			(marathi.getText()).isEmpty() || 
            	(science.getText()).isEmpty()) {
    	...
    	String url = "http://localhost:8080/result/api/v1/marksentry";
    	String jsonPayload = "{\n" + 
    				"\"grnNumber\"" + ":\"" + grn_Number.getText() + "\", \r\n" +
    				"\"english\"" + ":\"" + english.getText() + "\", \r\n" +
    				"\"maths\"" + ":\"" + maths.getText() + "\", \r\n" +
    				"\"marathi\"" + ":\"" + marathi.getText() + "\", \r\n" +
    				"\"science\"" + ":\"" + science.getText() + "\", \r\n" +
    				"\"hindi\"" + ":\"" + hindi.getText() + "\" \r\n" +
    				"\n}";
    	try {
    		// Create URL object
    		...
    		if(message.equals("Marks Updated")) {
    			Alert alert = new Alert(Alert.AlertType.INFORMATION);
    			alert.setTitle("Success");
    			alert.setHeaderText(null);
    			alert.setContentText("Marks Updated.");
    			alert.showAndWait();
    			new WelcomeTeacher().show();;
    		} 
    		
    		if(message.equals("Marks Entered Successfully")) {
    			Alert alert = new Alert(Alert.AlertType.INFORMATION);
    			alert.setTitle("Success");
    			alert.setHeaderText(null);
