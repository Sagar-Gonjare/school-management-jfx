...
public class ViewLeaveController {
    ...
    @FXML
    private TableColumn<ViewLeaveRecord, String> fromDate;

    @FXML
    private TableColumn<ViewLeaveRecord, Integer> grn_number;
    ...
    @FXML
    private TableColumn<ViewLeaveRecord, String> reason;

    @FXML
    private TableColumn<ViewLeaveRecord, String> status;

    @FXML
    private TableColumn<ViewLeaveRecord, String> studentFirstName;

    @FXML
    private TableColumn<ViewLeaveRecord, String> studentLastName;

    @FXML
    private TableView<ViewLeaveRecord> tableview;

    @FXML
    private Label title;

    @FXML
    private TableColumn<ViewLeaveRecord, String> toDate;
    ...
    private void displayTableView(List<ViewLeaveRecord> leaveList) {
        ...
        ObservableList<ViewLeaveRecord> observableExamRecords = FXCollections.observableArrayList(leaveList);
    ...
    public void initialize() {
    	...
    	try {
	        ...
	        List<ViewLeaveRecord> leaveList;
	        try {
	        	leaveList = objectMapper.readValue(response.toString(), new TypeReference<List<ViewLeaveRecord>>() {});
	        } catch (IOException e) {
	            e.printStackTrace();
	            return;
	        }
