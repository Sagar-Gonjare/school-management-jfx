...
public class TeacherNoticeController {
    ...
    public void save(ActionEvent event) {
    	...
    	String url = "http://localhost:8080/notice/api/v1/create";
        String jsonPayload = "{\n" + 
        ...
        try {
            ...
            if(message.equals("Notice created Successfully")) {
            	Alert alert = new Alert(Alert.AlertType.INFORMATION);
    			alert.setTitle("Success");
    			alert.setHeaderText(null);
    			alert.setContentText("Notice created Successfully.");
    			alert.showAndWait();
    			new WelcomeTeacher().show();
            } 
            
            if(message.equals("Notice already Created")) {
            	Alert alert = new Alert(Alert.AlertType.ERROR);
    			alert.setTitle("Error");
    			alert.setHeaderText(null);
    			alert.setContentText("Notice already Created.");
    			alert.showAndWait();
    			return;
            } 
        } catch (IOException e) {
